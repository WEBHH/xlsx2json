...
module.exports = {
  ...
  toJson: function (src, dest) {
    ...
    // console.log("parsing excel data -start:", workbook);

    // 删除多余空白行
    workbook.forEach(sheet => {
      _.remove(sheet.data, row => (!row || row.length == 0));
    });
    // console.log("parsing excel data end:", workbook);
